...
describe('Pool State', function () {
  it('Should return the pool state', async function () {
    const poolState = await getPoolState()
    expect(poolState).to.not.be.null
  })
})

describe('Immutable Pool', function () {
  it('Should return the immutables state', async function () {
    const poolImmutables = await getPoolImmutables()
    expect(poolImmutables).to.not.be.null
  })
})
